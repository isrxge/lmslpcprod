...
export async function PATCH(
  ...
  try {
    ...
    const emailContentForUpdate = {
      ...
      html: `
        <p style="font-family: 'Times New Roman', serif; font-size: 12pt;">Khóa học ${getCourse.title} đã được phát hành.</p>`,
    };
    ...
    const emailContentForStaff = {
      ...
      text: `Khóa học ${getCourse.title} đã được phát hành.`,
      html: `
        <p style="font-family: 'Times New Roman', serif; font-size: 12pt;">Khóa học ${getCourse.title} đã được phát hành, bạn có thể truy cập khóa học.</p>`,
    };
