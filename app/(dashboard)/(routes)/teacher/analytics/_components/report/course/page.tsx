...
//     }
//   };
//   const { data: data1, error: error1, isLoading: isLoading1 } = useQuery("userinfo", fetchUserPermission, {
...
//     fetchAllCourses,
//     {
//       enabled: !!data1, // This ensures the second query only runs when the first one is successful
//       refetchOnWindowFocus: false,
//     }
//   );
//   // const fetchAllCourses = async () => {
